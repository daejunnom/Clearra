...
pub use online_pc4_lookup_session::{
    ...
    AppQualifiedPc4LookupHit, Pc4FallbackCause, Pc4OfflineFallbackAuthorization,
    Pc4OfflineFallbackDisposition, Pc4OfflineFallbackSignal, Pc4OnlineLookupRequest,
};
