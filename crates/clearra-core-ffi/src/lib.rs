...
pub use buildup::{
    ...
    C_BUILDUP_HOLD_BRANCH_STORE_CURRENT, C_BUILDUP_HOLD_BRANCH_SWAP_HELD, C_COVERAGE_MAX_PATTERNS,
    C_COVERAGE_MAX_WORDS, C_COVERAGE_ROW_KIND_BUILD, C_SCORE_MATRIX_CAPACITY_EXCEEDED,
    C_SPIN_COVERAGE_CAPACITY_EXCEEDED,
};
...
pub use native::{
    ...
    CNativeBuildVariantView, CNativeBuildableGeometryStreamReport, CNativePruningMinimalRecord,
    CNativePruningProofLedger, CNativePruningProofLedgerEntry, CNativeResourceReport, CoreCNative,
    NativeBuildUpCountOutcome, NativeBuildUpOutcome, NativeBuildUpWorkspace,
    NativeBuildUpWorkspaceOutcome, NativeBuildableGeometryTaskOutcome, NativeCandidateReducer,
    NativeCoreError, NativeGeometryCatalog, NativeGeometryCatalogIdentity,
