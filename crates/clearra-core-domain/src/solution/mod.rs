...
pub use normalized_tiling_solution::{
    ...
    NormalizedTilingSolutionSetHasher, PiecePlacementMask, StandardBoard64ColoredTilingIdentity,
    StandardBoard64TilingIdentity, NORMALIZED_TILING_SOLUTION_KEY_ALGORITHM,
    NORMALIZED_TILING_SOLUTION_SET_HASH_ALGORITHM, STANDARD_BOARD64_TILING_MAX_PLACEMENTS,
};
