...
2026-09-10의 H/O1 독립 대조, 선택한 기본값, V0 수정과 실제 결과 렌더링
계측은 [후속 A/B 보고서](minimum-impact-and-partition-ab-2026-09-10.md)에 기록한다.
기존 배포 실행 ID나 아래 과거 후보 상태를 이번 최적화의 현재 결과로 해석하지 않는다.

2026-09-08 추가 소스 감사와 다음 A/B 후보 목록은
[병렬 비용·알고리즘 분석](minimum-parallel-overhead-and-algorithm-plan-2026-09-08.md)에
정리했다. 기존 제품 계약은 유지하며, 신규 H draft의 미검증 상태와 Qnia/Clearra의
서로 다른 종료 조건을 구분한다. 이 문서의 과거 실행 기록은 최신 CI 상태가 아니다.
