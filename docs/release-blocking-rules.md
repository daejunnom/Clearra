...
four process-isolated global-resource harnesses first, then runs the five
disjoint package harnesses, and collects every executable failure before
failing the stage. Cargo's
