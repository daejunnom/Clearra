...
const BUILD_V2_DISCORD_SURFACE_ROWS = Object.freeze(new Map([
  ["build.cover", {
    ...
    helpPolicy: "public", i18nPolicy: "en-ko-ja", resultAllowlist: ["build-coverage-portfolio.v2"],
    loweringAuthority: CLI_COMMAND_LOWERING_AUTHORITY,
...
const CAPABILITY_PRESENTATION = Object.freeze({
  ...
  "recovery.boundary": ["Search normal and boundary-recovery connections", "Submit one complete two-stage scenario; pattern evaluation reports unresolved supply separately.", "boundary-recovery"],
