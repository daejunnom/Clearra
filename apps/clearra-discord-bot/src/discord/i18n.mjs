...
const CATALOGS = Object.freeze({
  en: Object.freeze({
    ...
    "result.kind.public.score": "Jstris-score perfect-clear search",
    "result.kind.public.score_minimals": "minimum-cover Jstris-score search",
    "result.kind.public.saves": "perfect-clear save analysis",
    "result.kind.public.best_save": "perfect-clear save analysis",
    "result.kind.public.cover": "build-coverage search",
    "result.kind.public.setup": "target-setup probability search",
    "result.kind.public.congruent": "target-setup probability search",
    "result.kind.public.congruent_cover": "target-setup probability search",
    "result.kind.public.setup_cover": "target-cover probability search",
    "result.kind.public.cover_percent": "target-cover probability search",
    "result.kind.public.special_cover": "T-spin coverage search",
    "result.kind.public.spin_cover": "forward T-spin search",
    "result.kind.public.spin": "forward T-spin search",
    ...
    "result.kind.public.verify": "verification",
  ...
  ko: Object.freeze({
    ...
    "result.kind.public.score": "Jstris 점수 퍼펙트 클리어 탐색",
    "result.kind.public.score_minimals": "최소 커버 Jstris 점수 탐색",
    "result.kind.public.saves": "퍼펙트 클리어 세이브 분석",
    "result.kind.public.best_save": "퍼펙트 클리어 세이브 분석",
    "result.kind.public.cover": "구축 커버리지 탐색",
    "result.kind.public.setup": "목표 셋업 확률 탐색",
    "result.kind.public.congruent": "목표 셋업 확률 탐색",
    "result.kind.public.congruent_cover": "목표 셋업 확률 탐색",
    "result.kind.public.setup_cover": "목표 커버 확률 탐색",
    "result.kind.public.cover_percent": "목표 커버 확률 탐색",
    "result.kind.public.special_cover": "T-spin 커버리지 탐색",
    "result.kind.public.spin_cover": "정방향 T-spin 탐색",
    "result.kind.public.spin": "정방향 T-spin 탐색",
