...
const CATALOGS = Object.freeze({
  en: Object.freeze({
    ...
    "summary.best_save_schema": "Best-save schema",
    ...
    "summary.best_save_group": "Save group",
    "summary.best_save_canonical_candidate_id": "Canonical candidate ID",
    ...
    "summary.representative_order": "Canonical representative order",
    "summary.score_profile": "Score profile",
    "summary.score_accuracy_level": "Score accuracy",
    "summary.score_profile_specific_exact": "Profile-specific exact",
  ...
  ko: Object.freeze({
    ...
    "summary.best_save_schema": "최적 세이브 스키마",
    ...
    "summary.best_save_group": "세이브 그룹",
    "summary.best_save_canonical_candidate_id": "Canonical 후보 ID",
    ...
    "summary.candidate_id": "Canonical 후보 ID",
    "summary.operation_count": "Operation 수",
    "summary.cleared_line_count": "삭제한 줄 수",
    "summary.trace_key": "Canonical trace 키",
    "summary.rule_profile": "규칙 프로필",
    "summary.kick_profile": "킥 프로필",
    "summary.normalized_trace_preview": "Canonical trace 미리보기",
    ...
    "summary.representative_order": "Canonical 대표 순서",
    "summary.score_profile": "점수 프로필",
    "summary.score_accuracy_level": "점수 정확도",
    "summary.score_profile_specific_exact": "프로필별 정확성",
