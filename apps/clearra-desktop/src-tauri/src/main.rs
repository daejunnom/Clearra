...
use accelerator_commands::{
    accelerator_asset_action, accelerator_asset_cancel, accelerator_asset_progress,
    accelerator_asset_start_download, AcceleratorState,
};
use commands::{
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .manage(AcceleratorState::default())
