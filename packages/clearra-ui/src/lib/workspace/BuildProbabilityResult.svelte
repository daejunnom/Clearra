        ...
        <div class="metrics-panel">
          <div class="hero-metric">
            ...
            {:else}
              ...
              <small class="metric-footnote">{number(authorizedCoverage?.successfulPatternCount)} / {number(authorizedCoverage?.patternCount)} {label('patterns')}{summary.build_mirror_included === 'true' ? ` · ${label('originalAndMirror')}` : ''}</small>
            {/if}
          </div>
