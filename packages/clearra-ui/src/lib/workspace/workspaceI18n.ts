...
const en = {
  ...
  setupResidueHelp: 'Enter every piece remaining before the bag boundary, including an existing hold piece. One duplicated kind identifies that hold.',
  pcCycle: 'PC cycle',
...
const ko: Record<keyof typeof en, string> = {
  ...
  setupResidueHelp: '가방 경계 전까지 남은 미노를 모두 입력합니다. 기존 홀드가 있다면 함께 넣으며, 정확히 한 종류의 중복이 그 홀드를 나타냅니다.',
  pcCycle: 'PC 회차',
