...
const en = {
  ...
  setupModeQbHelp: 'Observe part of the following bag and use those pieces in the setup after the unordered cycle residue.',
  remainingPieces: 'Remaining pieces',
  setupObservedQueue: 'Observed next-bag pieces',
  setupQbInputHelp: 'Enter the unique pieces visible from the following standard bag. They are available after the cycle residue and must be used by the returned setup.',
  setupResidueHelp: 'Enter only the setup queue remaining before the next bag boundary. It is an unordered piece set, not the later PC completion queue.',
  ...
  setupQueueInitialHold: 'One duplicated kind identifies the independent initial hold. SIOS means setup pieces I/O/S plus held S. Without a duplicate, possible hold states remain separate conditions.',
  ...
  setupQbQueueLetters: 'The first group is the unordered cycle residue; the second is the observed subset of the following bag.',
  setupQbAllPieces: 'Both groups are available to the setup. Clearra infers the unobserved complement of the following bag.',
  setupQbSevenLimit: 'Cycle residue plus observed pieces may contain at most seven pieces, and observed pieces cannot repeat.',
  setupObservedPieces: 'Observed QB pieces',
  pcCycle: 'PC cycle',
  cycleNumber: 'Cycle {cycle}',
  initialHold: 'Initial hold',
  holdConditionsSeparated: 'Separated conditions',
  ...
  noSetups: 'No buildable setup matched this hold condition.',
  ...
  allBuildSolutions: 'All build solutions',
  loadingBuildSolutions: 'Loading build solutions',
  loadingExactBuildSolutions: 'Enumerating every distinct exact build for this setup.',
  loadExactBuildSolutions: 'Open to enumerate every distinct exact build for this setup.',
  noBuildSolutions: 'No exact build solution was retained for this setup.',
  buildSolutionNumber: 'Build solution {number}',
  pathDetailFailed: 'The exact build solutions could not be loaded.',
  pathDetailUnavailable: 'The browser worker needed for exact build solutions is unavailable.',
  retry: 'Retry',
  ...
  setup_residue_duplicate_invalid: 'At most one piece kind may occur twice; that duplicate represents the initial hold.',
  setup_cycle_borrow_invalid: 'Borrowing after cycle reset is available only for cycle 7.',
  setup_qb_count_invalid: 'Queue-based setup search requires at least one observed next-bag piece.',
  setup_qb_piece_invalid: 'Observed QB input may contain only I, O, T, S, Z, J, and L.',
  setup_qb_duplicate_invalid: 'Observed QB pieces must be a subset of one standard bag and therefore cannot repeat.',
  setup_qb_combined_count_invalid: 'Cycle residue and observed QB pieces may contain at most seven pieces in total.',
...
const ko: Record<keyof typeof en, string> = {
  ...
  setupModeQbHelp: '회차 잔여 미노 뒤에 다음 가방에서 관측한 일부 미노를 공급하고, 해당 미노를 실제 셋업에 사용합니다.',
  remainingPieces: '남은 미노',
  setupObservedQueue: '관측한 다음 가방 미노',
  setupQbInputHelp: '다음 표준 가방에서 보이는 서로 다른 미노를 입력합니다. 회차 잔여 뒤에 공급되며 반환 셋업이 모두 사용해야 합니다.',
  setupResidueHelp: '다음 bag 경계 전까지 남은 셋업 큐만 입력합니다. 이는 순서 없는 미노 집합이며 이후 PC 완성 큐는 입력하지 않습니다.',
  setupQueueSyntax: '셋업 큐 문법',
  setupQueueLetters: '미노 문자만 입력합니다. 대소문자는 같게 처리하고 공백과 쉼표는 구분자로 쓸 수 있으며, 작성 순서는 배치 순서를 고정하지 않습니다.',
  setupQueueInitialHold: '정확히 한 종류의 중복은 독립적인 초기 홀드를 뜻합니다. SIOS는 셋업 미노 I/O/S와 홀드 S를 의미합니다. 중복이 없으면 가능한 홀드 상태를 조건별로 분리합니다.',
  ...
  setupQbQueueLetters: '첫 그룹은 순서 없는 회차 잔여이며, 둘째 그룹은 다음 가방에서 관측한 부분집합입니다.',
  setupQbAllPieces: '두 그룹 모두 셋업에 사용할 수 있으며, 다음 가방에서 보이지 않은 나머지는 Clearra가 자동으로 계산합니다.',
  setupQbSevenLimit: '회차 잔여와 관측 미노의 합은 7개 이하이고 관측 미노는 중복될 수 없습니다.',
  setupObservedPieces: '관측 QB 미노',
  pcCycle: 'PC 회차',
  cycleNumber: '{cycle}회차',
  initialHold: '초기 홀드',
  holdConditionsSeparated: '홀드 조건별 분리',
  ...
  noSetups: '이 홀드 조건에서 구축 가능한 셋업이 없습니다.',
  ...
  allBuildSolutions: '전체 구축 해법',
  loadingBuildSolutions: '구축 해법 불러오는 중',
  loadingExactBuildSolutions: '이 셋업의 서로 다른 정확한 구축 해법을 모두 탐색하고 있습니다.',
  loadExactBuildSolutions: '열면 이 셋업의 서로 다른 정확한 구축 해법을 모두 탐색합니다.',
  noBuildSolutions: '이 셋업에 보존된 정확한 구축 해법이 없습니다.',
  buildSolutionNumber: '구축 해법 {number}',
  pathDetailFailed: '정확한 구축 해법을 불러오지 못했습니다.',
  pathDetailUnavailable: '정확한 구축 해법을 계산할 브라우저 워커를 사용할 수 없습니다.',
  retry: '다시 시도',
  useCurrent: '현재 미노 사용',
  swapHeld: '홀드 교환',
  ...
  setup_residue_duplicate_invalid: '중복되는 미노 종류는 하나만 허용되며, 그 중복은 초기 홀드를 나타냅니다.',
  setup_cycle_borrow_invalid: '주기 초기화 이후 미노 사용은 7회차에서만 허용됩니다.',
  setup_qb_count_invalid: 'Queue-based 셋업에는 관측한 다음 가방 미노가 하나 이상 필요합니다.',
  setup_qb_piece_invalid: '관측 QB에는 I, O, T, S, Z, J, L만 사용할 수 있습니다.',
  setup_qb_duplicate_invalid: '관측 QB는 한 표준 가방의 부분집합이므로 같은 미노를 중복할 수 없습니다.',
  setup_qb_combined_count_invalid: '회차 잔여와 관측 QB 미노의 합은 7개 이하여야 합니다.',
