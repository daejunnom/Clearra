...
const en = {
  ...
  setupResidueHelp: 'Enter the unique setup pieces remaining before the next bag boundary. Product search starts with an empty hold; explicit initial hold is a CLI-only option.',
...
const ko: Record<keyof typeof en, string> = {
  ...
  setupResidueHelp: '다음 bag 경계 전까지 남은 서로 다른 셋업 미노를 입력합니다. 제품 탐색은 빈 초기 홀드로 시작하며, 초기 홀드 지정은 CLI 전용입니다.',
