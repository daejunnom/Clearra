...
const en = {
  ...
  setupModeOracleHelp: 'Find setup shapes over the unordered cycle residue. Queue knowledge is selected separately below.',
  ...
  automatic: 'Automatic',
  hold: 'Hold',
  queueKnowledge: 'Future queue knowledge',
  queueKnowledgeOracle: 'Full future (Oracle)',
  queueKnowledgeVisibleSeven: 'Visible 7 pieces',
  queueKnowledgeOracleHelp: 'Each complete queue may choose its best legal plan. This is an upper bound when later pieces are hidden.',
  queueKnowledgeVisibleSevenHelp: 'Decisions use only the current hold and seven visible pieces, then may branch as later pieces are revealed.',
  empty: 'Empty',
  search: 'Search',
  rule: 'Rule',
  ...
  visibleSevenCoverage: 'Policy (seven visible pieces)',
  jointProbability: 'Build + PC probability',
  conditionalPcProbability: 'PC probability after build',
  conditionalCoverageRatio: 'Joint / build coverage ratio',
  ...
  solutionCopyFormatHelp: 'Fumen preserves piece colors. CTK copies Clearra’s compact solution key.',
...
const ko: Record<keyof typeof en, string> = {
  ...
  setupModeOracle: 'Shape oracle',
  setupModeQb: 'Queue-based',
  setupModeOracleHelp: '순서 없는 회차 잔여 미노에서 셋업 모양을 찾습니다. 미래 큐 정보 범위는 아래에서 별도로 선택합니다.',
  ...
  automatic: '자동',
  hold: '홀드',
  queueKnowledge: '미래 큐 정보',
  queueKnowledgeOracle: '미래 전체 공개 (Oracle)',
  queueKnowledgeVisibleSeven: '앞 7개만 공개',
  queueKnowledgeOracleHelp: '완성된 큐마다 최선의 합법 계획을 고릅니다. 이후 미노가 숨겨진 실제 플레이에서는 상한입니다.',
  queueKnowledgeVisibleSevenHelp: '현재 홀드와 보이는 7개만으로 행동을 정하고, 이후 미노가 새로 보일 때 정책을 분기합니다.',
  empty: '비어 있음',
  search: '탐색',
  rule: '룰',
  scoreMode: '결과 집계',
  ...
  visibleSevenCoverage: '정책 (보이는 7개 미노)',
  jointProbability: '구축 + PC 확률',
  conditionalPcProbability: '구축 후 PC 확률',
  conditionalCoverageRatio: 'Joint / 구축 커버리지 비율',
  ...
  solutionCopyFormatHelp: 'Fumen은 미노 색을 보존합니다. CTK는 Clearra의 압축 해법 키를 복사합니다.',
  copySolution: '해법 복사',
