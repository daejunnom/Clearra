...
const EXPECTED_RELEASE_REGRESSIONS = Object.freeze([
  ...
  "scripts/release/fast-correction-authority.test.mjs",
  "scripts/release/fast-correction-evidence.test.mjs",
  "scripts/release/fast-correction-plan.test.mjs",
  "scripts/release/fast-correction-workflow.test.mjs",
