...
$manager = Get-ClearraManageExecutable -RepositoryRoot $repository
& $manager --root $repository runtime wsl run `
...
& $manager --root $PWD runtime wsl run --entry posix-syntax-audit -- `
