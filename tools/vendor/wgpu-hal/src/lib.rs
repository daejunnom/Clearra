...
#[cfg(any(all(target_os = "windows", feature = "dx12"), all(feature = "gles", any(not(target_arch = "wasm32"), all(target_vendor = "unknown", target_os = "unknown"), target_os = "emscripten")), all(target_vendor = "apple", feature = "metal"), all(not(target_arch = "wasm32"), feature = "vulkan")))]
#[macro_use]
extern crate std;
...
#[cfg(any(feature = "gles", all(not(target_arch = "wasm32"), feature = "vulkan"), all(target_vendor = "apple", feature = "metal")))]
...
#[cfg(all(any(feature = "gles", all(not(target_arch = "wasm32"), feature = "vulkan"), all(target_vendor = "apple", feature = "metal")), any(not(target_arch = "wasm32"), all(target_os = "emscripten", feature = "gles"))))]
impl DropGuard {
...
#[cfg(any(all(target_os = "windows", feature = "dx12"), all(not(target_arch = "wasm32"), feature = "vulkan")))]
...
#[cfg_attr(not(any(all(target_os = "windows", feature = "dx12"), all(not(target_arch = "wasm32"), feature = "vulkan"))), expect(dead_code))]
