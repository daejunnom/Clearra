...
impl super::Instance {
    ...
    pub fn desired_extensions(
        ...
        if cfg!(all(feature = "drm", any(target_os = "linux", target_os = "freebsd", target_os = "netbsd", target_os = "openbsd"))) {
...
impl crate::Instance for super::Instance {
    ...
    unsafe fn create_surface(
        ...
        match (window_handle, display_handle) {
            ...
            #[cfg(all(feature = "drm", any(target_os = "linux", target_os = "freebsd", target_os = "netbsd", target_os = "openbsd")))]
