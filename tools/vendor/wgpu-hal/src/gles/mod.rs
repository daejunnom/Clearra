...
///cbindgen:ignore
#[cfg(not(any(windows, all(target_arch = "wasm32", not(target_os = "emscripten"), feature = "gles"))))]
mod egl;
...
#[cfg(not(all(target_arch = "wasm32", not(target_os = "emscripten"), feature = "gles")))]
...
cfg_if::cfg_if! {
    if #[cfg(all(feature = "gles", any(not(target_arch = "wasm32"), all(target_vendor = "unknown", target_os = "unknown"), target_os = "emscripten")))] {
        ...
        #[cfg(all(any(not(target_arch = "wasm32"), all(feature = "fragile-send-sync-non-atomic-wasm", not(target_feature = "atomics"))), not(feature = "fragile-send-sync-non-atomic-wasm")))]
