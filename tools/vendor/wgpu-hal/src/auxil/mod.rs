...
#[cfg(any(all(target_os = "windows", feature = "dx12"), all(all(not(target_arch = "wasm32"), feature = "vulkan"), windows)))]
pub(super) mod dxgi;
...
#[cfg_attr(not(any(all(target_os = "windows", feature = "dx12"), all(target_vendor = "apple", feature = "metal"), all(not(target_arch = "wasm32"), feature = "vulkan"), feature = "gles")), allow(dead_code))]
