...
pub(super) enum CompilerContainer {
    ...
    #[cfg_attr(not(all(target_os = "windows", feature = "static-dxc", not(target_arch = "aarch64"), target_env = "msvc")), allow(unused))]
...
impl CompilerContainer {
    ...
    pub(super) fn new_static_dxc() -> Result<CompilerContainer, crate::DeviceError> {
        #[cfg(all(target_os = "windows", feature = "static-dxc", not(target_arch = "aarch64"), target_env = "msvc"))]
        {
            unsafe {
        ...
        #[cfg(not(all(target_os = "windows", feature = "static-dxc", not(target_arch = "aarch64"), target_env = "msvc")))]
        {
